...
SECRET_KEY = 'django-insecure-p18wr!xivhnq26*iv&2!3%8x*cs)#a#g--(uob#*ll!x595b@k'
...
MIDDLEWARE = [
    ...
    'vehicles.middleware.IPFilterMiddleware',
]
...
# --- Basic security headers to help against XSS ---
